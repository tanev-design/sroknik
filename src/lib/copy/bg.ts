...
export const copy = {
  ...
  plusV2: {
    ...
    priceEur: '€4.99',
    priceBgn: 'или 9.99 лв.',
    stripeNote:
      'Плащането се обработва от Stripe. Ние не виждаме данните ти за плащане. Получаваш лицензен ключ на имейл веднага след плащане.',
    ...
    trust: {
      ...
      noSubTitle: 'Без абонамент',
      noSubBody: 'Плащаш еднократно. Ключът работи на до 3 устройства.',
    ...
    faq: [
      ...
      {
        q: 'Мога ли да използвам ключа на телефон и компютър?',
        a: 'Да — ключът може да се активира на до 3 устройства. Ако смениш устройство, пиши ни.'
      },
      {
        q: 'Как ще получа ключа?',
        a: 'Веднага след плащане, Stripe ни изпраща потвърждение и ключът ти пристига на посочения имейл. Пази го — не го изпращаме повторно.'
      },
      {
        q: 'Продавате ли ми данните?',
        a: 'Не. Не пазим нищо освен хеш на имейла ти (за да знаем, че ключът е валиден).'
      }
    ]
  },
